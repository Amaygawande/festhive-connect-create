...
const Hero = () => {
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: 'url(/images/festival-bg.jpg)' }}>
      <div className="absolute inset-0 bg-gradient-to-b from-festblue/70 to-festblue/90"></div>
